...
RETURNS TEXT AS $$
    SELECT CASE
        ...
        WHEN subclass IN ('greengrocer') THEN 'greengrocer'
        WHEN subclass IN ('supermarket','deli','delicatessen','department_store','marketplace') THEN 'grocery'
        ...
        WHEN subclass IN ('chocolate','confectionery') THEN 'pastry'
