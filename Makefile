...
build/indoorequal.tm2source/data.yml: init-dirs
	...
	docker-compose run $(DC_OPTS) openmaptiles-tools generate-tm2source indoorequal.yaml --host="postgres" --port=5432 --database="openmaptiles" --user="openmaptiles" --password="openmaptiles" > $@
